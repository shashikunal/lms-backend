...
notificationRouter.get(["/get-all-notification", "/get-all-notifications"], auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), notification_controller_1.getNotifications);
